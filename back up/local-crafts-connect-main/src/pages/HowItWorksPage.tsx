    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="bg-brand-500 text-white py-20 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl font-bold mb-4">How LocalPro Works</h1>
              ...
              <div className="md:w-1/2 order-1 md:order-2">
                ...
                <div className="space-y-4">
                  <div className="flex">
                    ...
                    <p>Get reminders before your scheduled appointment</p>
                  </div>
                  <div className="flex">
                    <CheckCircle className="h-6 w-6 text-amber-600 mr-3 shrink-0" />
                    <p>Communicate with your provider through our secure messaging system</p>
                  </div>
                  <div className="flex">
                    <CheckCircle className="h-6 w-6 text-amber-600 mr-3 shrink-0" />
                    <p>Receive professional service at your specified location</p>
                  </div>
                  <div className="flex">
                    <CheckCircle className="h-6 w-6 text-amber-600 mr-3 shrink-0" />
                    <p>Make secure payment through our platform after service completion</p>
                  </div>
                  <div className="flex">
                    <CheckCircle className="h-6 w-6 text-amber-600 mr-3 shrink-0" />
                    <p>Leave a review to help other users and provide feedback to the provider</p>
                  </div>
                </div>
              </div>
            </div>
