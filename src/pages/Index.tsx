      ...
      <section className="hero-pattern relative px-4 py-20 md:py-32">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
            <span className="block text-brand-500">Tippy</span>
          ...
          <p className="mx-auto mt-2 max-w-md text-brand-600 font-semibold">Your trusted local service marketplace</p>
          ...
          {/* Map showing user and providers */}
          <div className="mt-8">
            <TrackingProvider>
              <MapView className="h-96 w-full mx-auto" />
            </TrackingProvider>
          </div>
        </div>
      </section>
